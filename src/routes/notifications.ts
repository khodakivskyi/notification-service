...
import {sendVerification, sendNotification, uuidParam, userIdParam} from '../schemas/notificationSchemas'
 ...
 */
router.post('/send-verification', validate(sendVerification), async (req: Request, res: Response, next: NextFunction) => {
    try {
 ...
 */
router.post('/send', validate(sendNotification), async (req: Request, res: Response, next: NextFunction) => {
    try {
 ...
 */
router.get('/user/:userId/stats', validate(userIdParam), async (req: Request, res: Response, next: NextFunction) => {
    try {
